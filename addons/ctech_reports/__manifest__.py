...
""",
    ...
    'data': [
        ...
        'reports/test_wise_single_dept_view.xml',
        'reports/all_department_collection_user_report_view.xml',
        ...
        'wizards/test_wise_single_dept_wzd_view.xml',
        'wizards/all_department_user_bill_collection_view.xml',
    ],
    'demo': [],
    'qweb': [],
    'installable': True,
