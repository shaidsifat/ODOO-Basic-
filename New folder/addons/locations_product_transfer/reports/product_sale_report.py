...
class AbstractModelReportDeliver(models.AbstractModel):
    _name = 'report.locations_product_transfer.product_transfer'
    ...
    def render_html(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('locations_product_transfer.product_transfer')

        data_collection, locate_name = self.data_for_inventory_report(docs.start_date, docs.end_date, docs.locate_id.id, data['list'])
        ...
        return self.env['report'].render('locations_product_transfer.product_transfer', docargs)
